...
private const val CHARACTER_API_LINK = "https://chargen-api.herokuapp.com/"
...
object CharacterGenerator {
    ...
    private fun fromApiData(apiData: String): CharacterData {
    ...
    suspend fun fetchCharacterData(): CharacterData {
        return withContext(Dispatchers.Default) {
            val apiData = URL(CHARACTER_API_LINK).readText()
            fromApiData(apiData)
        }
    }
